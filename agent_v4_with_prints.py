...
class Agent:
    ...
    def has_finished_episode(self):
        if self.num_steps_taken % self.episode_length == 0:
            ...
            self.reached = True
            self.wall_after_goal = False
            print('Iteration ' + str(self.number_of_episode))
            ...
            if self.improve_epsilon == True:
                if self.epsilon > 0.21 and self.K % 5 == 0:
        ...
        if self.evaluate_epsilon_greedy == True:
            if distance_to_goal < 0.03:
                ...
                if 300 > self.num_steps_taken_greedy_policy > 100:
                    self.improve_epsilon = True       #The decay rate is -0.05 every 5 episodes
                    self.decrease_slowly = False
                if self.num_steps_taken_greedy_policy > 300:
                    self.improve_epsilon = False
                    self.decrease_slowly = True  #The decay rate is -0.05 every 10 episodes
